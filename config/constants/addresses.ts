...
export const STAKING_ADDRESS: ChainMap<Hash> = {
  ...
  [ChainId.SEPOLIA]: '0x4faf546608e61269e7d361be45990daceb4a0ff1',
...
export const STAKED_TOKEN_ADDRESS: ChainMap<Hash> = {
  ...
  [ChainId.SEPOLIA]: '0x16faf9f73748013155b7bc116a3008b57332d1e6',
...
export const WETH_ADDRESS: ChainMap<Hash> = {
  ...
  [ChainId.SEPOLIA]: '0xdfcea9088c8a88a76ff74892c1457c17dfeef9c1',
...
export const WNCG_ADDRESS: ChainMap<Hash> = {
  ...
  [ChainId.SEPOLIA]: '0xa488533be3018a0720c4c0647f407f3b41e6cb82',
...
export const BAL_ADDRESS: ChainMap<Hash | null> = {
  ...
  [ChainId.SEPOLIA]: '0xfa8449189744799ad2ace7e0ebac8bb7575eff47',
  [ChainId.BSC]: null,
