...
export const StyledAddLiquidityPoolBalances = styled(motion.section)`
  position: sticky;
  top: 0;
  border-radius: 12px;
  overflow: hidden;
...
export const StyledAddLiquidityPoolBalancesHeader = styled.header`
  min-height: ${POOL_BALANCES_HEIGHT}px;
`

export const StyledAddLiquidityPoolBalancesContent = styled.div`
  padding: 32px;
